...
# For TensorFlow 2.0, we require CUDA >=10.0 and CuDNN >=7.4
module load Python/3.6.3-foss-2017b
module load CUDA/10.0.130
export LD_LIBRARY_PATH=$HOME/sdk/cuda/lib64:$LD_LIBRARY_PATH
...
### PROGRAM ###
python3 main.py --dataset data/ml-1m.txt --train_dir tf2_epoch_500_maxlen_200_dropout_0.2 --maxlen=200 --dropout_rate=0.2 --num_epochs 500
